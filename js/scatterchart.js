...
ScatterChart.prototype.initVis = function () {
    ...
    vis.svg.append("circle").attr("cx", 420).attr("cy", -35).attr("r", 4).style("fill", "#3fc5f0")
    vis.svg.append("circle").attr("cx", 420).attr("cy", -21).attr("r", 4).style("fill", "#42dee1")
    vis.svg.append("circle").attr("cx", 420).attr("cy", -6).attr("r", 4).style("fill", "#6decb9")
    vis.svg.append("circle").attr("cx", 420).attr("cy", 8).attr("r", 4).style("fill", "#eef5b2")
    vis.svg.append("text").attr("id","age").attr("x", 430).attr("y", -34).text("0-5 years").style("font-size", "12px").style('fill','white').attr("alignment-baseline", "middle");
    vis.svg.append("text").attr("id","age").attr("x", 430).attr("y", -22).text("5-9 years").style("font-size", "12px").style('fill','white').attr("alignment-baseline", "middle");
    vis.svg.append("text").attr("id","age").attr("x", 430).attr("y", -7).text("9-14 years").style("font-size", "12px").style('fill','white').attr("alignment-baseline", "middle");
    vis.svg.append("text").attr("id","age").attr("x", 430).attr("y",10).text(">14 years").style("font-size", "12px").style('fill','white').attr("alignment-baseline", "middle")
